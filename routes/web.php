...
Route::group(['prefix'=>'users'], function(){
    ...
    Route::get('/export-csv', 'Users@exportCSV'); 
    Route::get('/bulk-upload', 'Users@bulkUploadView');
    Route::post('/bulk-upload-user', 'Users@bulkUploadUsers')->name('uploadUser');
    Route::get('/getmail/{id}', 'Users@getmail');
});
